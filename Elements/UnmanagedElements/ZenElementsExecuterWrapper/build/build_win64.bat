...
set elementName=ZenElementsExecuterWrapper
set elementExports=ZENELEMENTSEXECUTERWRAPPER_EXPORTS

set includedirs=/I""%ZENO_ROOT%"\ZenCommon" /I""%ZENO_ROOT%"\Elements\libs\ZenCoreCLR" /I""%ZENO_ROOT%"\libs\pthread\1.0.0.0\src" /I""%ZENO_ROOT%"\libs\zip\1.0.0.0\src"
